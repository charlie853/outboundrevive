export const metadata = {
  ...
  description: 'How we collect SMS consent, frequency, PAUSE/HELP, and sample messages.',
};
      ...
      <section className="relative overflow-hidden rounded-2xl border border-surface-line bg-surface-card shadow-soft px-6 md:px-10 py-8">
        ...
        <div className="mt-6 space-y-4 text-ink-2">
          ...
          <div className="rounded-xl border border-surface-line bg-white p-4">
            ...
            <p className="mt-2">
              I agree to receive SMS from OutboundRevive about my account and follow-ups. Msg &amp; data rates may apply. Up to 4 msgs/mo. Reply <code>PAUSE</code> to pause reminders, <code>HELP</code> for help. Consent not a condition of purchase. See our <a className="underline" href="/privacy">Privacy Policy</a> and <a className="underline" href="/terms">Terms</a>.
            </p>
          </div>
          ...
          <p><strong className="text-ink-1">Opt-Out:</strong> Reply <code>PAUSE</code> to pause reminders at any time. Reply <code>RESUME</code> to continue.</p>
          ...
          <div className="rounded-xl border border-surface-line bg-white p-4">
            ...
            <p className="mt-2">
              OutboundRevive: Hi &#123;first_name&#125;, this is Charlie following up about your recent service. Any questions or next steps I can help with? Reply <code>PAUSE</code> to pause reminders, <code>HELP</code> for help.
            </p>
          </div>
